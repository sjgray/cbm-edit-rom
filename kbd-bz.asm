; PET/CBM EDIT ROM - Keyboard Matrix Table - Business Keyboard - QWERTZ layout
; ================   For simple keyboard scanner
;
; QWERTZ layout. Same as standard "B" layout except Y/Z swapped. No other changes.
...
;       -------------------------------------   ----- ----- ----- ----- ----- ----- ----- -----        
	...
	!byte $B2,$10,$0F,$B0,$2C,$4E,$56,$59 ; 2     RPT   $$-0F 0     ,     N     V     Y     | ROW2 
