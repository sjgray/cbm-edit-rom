...
; NOTE!: SuperPET requires a special adapter to use EPROMS and has compatibility issues with 4K edit roms (see web page)
;
;----------------------------------------------------------------------------------------------------------------------------
...
COLOURPET = 1	; Full Colour additions?	0=No, 1=Yes
...
BACKACTION= 2   ; BackArrow Action		0=Text/Graphic, 1=40/80,2=BG	Which BackArrow Action? NOTE: 40/80 requires ESC Codes!
...
;-- Debugging
DEBUG 	  = 0     ; Add INLINE debugging?	0=No, 1=YES                     Inline Debug
IRQDEBUG  = 0     ; Add IRQ debugging?          0=No, 1=Yes                     IRQ Debug. WARNING! May cause issues with timing-critical operations!!!
IRQMEM    = $00B1 ; Start Memory location       $0000-$FFFF			IRQ Debug Memory Start
IRQBYTES  = 0     ; How many to show?           23,47,79 depending on system    Normal: 40-col=24, 80-col=48, 8296=80 (subtract 1 for IRQ at start of line)
...
BYPASSBG  = 0   ; ColourPET Bypass BG     	0 to 15 RGBI                    and also for BACKARROW=2 in ColourPET mode
