...
; ==========================   !4296D.asm
; sjg-40-B-50-4296D, CBMROM=1  - Based on 4032B settings except for special 8296D Monitor CRTC settings (Refresh=3).
;
...
CBMROM    = 1   ; For CBM ROM specific code	0=none, 1-10 = CBM ROM #	Normal is 0.
...
;-- Screen
REFRESH   = 3	; Screen refresh:		1=N.A., 0/2/3=Euro (3=8296D)    Other: 15=PAL,16=NTSC,9/10=9",32=32-line,35=35-line,90=90x35,99=Custom
