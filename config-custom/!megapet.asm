...
BACKACTION= 0   ; BackArrow Action		0=Text/Graphic, 1=40/80,2=BG	Which BackArrow Action? NOTE: 40/80 requires ESC Codes!
...
!TO "binaries/megapet-test.bin",plain			; Generic output file with no load address
