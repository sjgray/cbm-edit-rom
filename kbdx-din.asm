...
KEYBOARD_SHIFTED
!byte $96,$00,$3F,$93,$29,$26,$40,$3E		;ShCtrlV	LSHIFT	?		RUN		)		&		@		>
!byte $A2,$5F,$95,$94,$CD,$A0,$D8,$00		;Grph a2	UNDERLINE	ShCtrl U	LEFT		M		SH-SPACE	X		RUN
!byte $A3,$83,$8F,$A1,$3B,$CE,$D6,$D9		;Grph a3	UP		ShCtrl O	Grph a1	;		N		V		Y
!byte $A4,$00,$99,$DE,$3A,$C2,$C3,$00		;Grph a4	RSHIFT	ShCtrl Y	PI		:		B		C		LSHIFT
!byte $A5,$DD,$CF,$5E,$D5,$D4,$C5,$D1		;Grph a5	UE		O		UP		U		T		E		Q
!byte $5C,$D0,$C9,$2A,$DA,$D2,$D7,$89		;\		P		I		*		Z		R		W		SET-TAB
!byte $A7,$DB,$CC,$8D,$CA,$C7,$C4,$C1 	;Grph a7	OE		L		SH RETURN	J		G		D		A
!byte $A6,$DC,$CB,$27,$C8,$C6,$D3,$1B		;Grph a6	OE		K		'		H		F		S		ESC
!byte $AA,$00,$91,$A8,$3D,$2F,$24,$21		;Grph aa	SHIFT		CLR		Grph a8	=		/		$		!
!byte $00,$8E,$9D,$A9,$C0,$28,$25,$22		;SHIFT	ShCtrl N	INS		Grph a9	ac-grave	(		%		"
