; PET/CBM Editor ROM Project - Extended ROM Code for CRTC Screen configuration
; ==========================   EXTCRT.ASM
;
; This code goes in the upper half of the 4K EDIT ROMS.
; Requires:
;	CRTC-REG-NORMAL.ASM - Primary tables, defined by KEYBOARD setting.
;	CRTC-REG-OLD.ASM    - Secondary tables, defined by CBMROM setting.
