; PET/CBM Editor ROM Project - Extended Keyboard Scanner from 8296D, 324243-04 ROM
; ==========================   EXTKEYSCAN.ASM
;
; This code is for CODEBASE 2 but might work in 0 or 1 with some work?
...
SCAN_NORM2                                                      ; for compatibility to KEYSCAN-B
                LDX CharsInBuffer
                CPX XMAX
                BCC Be9df
                BCS Be9e4
