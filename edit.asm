...
!macro COMMENT { !pet "sjg edit rom-40-b-60-esc-wedge-reboot-backarrow (dev)" }
...
REFRESH   = 1	; Screen refresh:		0=Euro, 1=N.America, 2=PAL, 3=NTSC, 4=9", 5=8296/35-line, 6=8296/32-line, 7=8296D Euro, 8=8296D N.A. 99=Custom
...
CRUNCH    = 1   ; Remove unneeded code (NOPS) when posible? 0=No, 1=Yes
