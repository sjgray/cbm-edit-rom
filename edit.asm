...
BANNER    = 16  ; Custom Banner (power on msg)	0=No, N=Banner# (1-18,98,99)    Valid when AUTORUN=1. Refer to docs or source. 99=custom message
...
AUTOBOOT  = 1	; AutoBOOT first file on disk	0=No, 1=Yes			Valid when AUTORUN=1.

SOFT40    = 0	; 40 columns on 8032s?		0=No, 1=Yes			Do NOT enable SOFT40 and SS40 at the same time!
SS40      = 0	; Software Switchable Soft-40	0=No, 1=Yes			Also set ESCCODES=1, or BACKARROW>0 and BACKACTION=1.
...
BACKARROW = 0   ; Backarrow Hack code?		0=NO, 1=Yes, 2=Yes EXT		Where to put the Action Code. Note: B keyboard scanner only.
BACKACTION= 0   ; Backarrow Action		0=Text/Graphic, 2=40/80		Which Action?
