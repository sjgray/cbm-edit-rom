...
REFRESH   = 0	; Screen refresh:		0=Euro,1=N.America,2=PAL,3=NTSC,4=9",5=8296/35-line,6=8296/32-line,7=8296D Euro,8=8296D N.A.
...
BANNER    = 16  ; Custom Banner (power on msg)  0=No, N=Banner# (1-16, or 99)   Valid when AUTORUN=1. Refer to docs or source. 99=debug message
