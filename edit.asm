...
!macro DATE    { !pet "2018-11-29" }
!macro COMMENT { !pet "sjg-edit-8296d-c1-din-50-execudesk (2018-11-29)" }
...
BANNER    = 0   ; Custom Banner (power on msg)  0=No, N=Banner# (1-12, or 99)   Valid when AUTORUN=1. Refer to docs or source. 99=debug message
