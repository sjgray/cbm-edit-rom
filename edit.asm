...
!macro COMMENT { !pet "sjg-edit-c0-8296d-wedge-soft40-reboot-backarrow (2018-11-28)" }
...
BANNER    = 17  ; Custom Banner (power on msg)  0=No, N=Banner# (1-12, or 99)   Valid when AUTORUN=1. Refer to docs or source. 99=debug message
