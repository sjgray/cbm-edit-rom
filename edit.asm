...
REFRESH   = 6	; Screen refresh:		0=Euro, 1=NorthAmerica, 2=PAL, 3=NTSC, 4=9", 5=8296/35-line, 6=8296/32-line, 9=Custom
REPEATOPT = 0	; Key Repeat Option		0=No (Always ON), 1=Yes
COLUMNS   = 80	; Screen Width			40,80,90,32 columns		Special cases 32 or 90
ROWS      = 32  ; Screen Height			25,35,16 rows			Special cases 16 or 35
...
BANNER    = 9   ; Custom Banner (power on msg)  0=No, N=Banner# (1-9, or 99)    Refer to docs or source. 99=debug message
