...
; ================   EXPERIMENTAL! 80 Column x 35 Line, 60 Hz Line, 20?? kHz Horizontal (for 8296 internal monitor)
;
...
;       in 'text' mode.
;
;--------- Text Mode - 80 Columns x 35 Rows, 60 Hz, 20 kHz (approximate)

CRT_CONFIG_TEXT
           !byte 47,40,41,15,40,7,35,39,0,7,0,0,16,0,0,0,0,0 
