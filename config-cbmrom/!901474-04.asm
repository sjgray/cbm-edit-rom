...
CBMROM    = 4   ; For CBM ROM specific code	0=none, 1-10 = CBM ROM #	Normal is 0.
...
;-- Screen
REFRESH   = 2	; Screen refresh:		0/2=Euro,1=N.A.,15=PAL,16=NTSC,9/10=9",82=8296,32=32-line,35=35-line,90=90x35,99=Custom
