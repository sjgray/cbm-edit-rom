...
; ==========================   !324243-02b-c2.asm
; edit-8296d-324243-02b-ascii  8296D     CBMROM=6
;
...
CBMROM    = 6   ; For CBM ROM specific code	0=none, 1-10 = CBM ROM #	Normal is 0.
...
;-- Screen
REFRESH   = 3	; Screen refresh:		0/2=Euro,1=N.A.3=8296D,15=PAL,16=NTSC,9/10=9",82=8296,32=32-line,35=35-line,90=90x35,99=Custom
