...
; ==========================   !324243-02b-c1.asm
; edit-4-80-B-60?    8032      CBMROM=5
;
; This seems to be based on the 901474-03
; There is a difference of 31 bytes between the two roms, mostly in the CRT registers.
;
...
CBMROM    = 5   ; For CBM ROM specific code	0=none, 1-10 = CBM ROM #	Normal is 0.
